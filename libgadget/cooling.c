...
void init_cooling(char * TreeCoolFile, char * RecFastFile, char * MetalCoolFile, char * UVFluctuationFile, struct cooling_units cu, Cosmology * CP)
{
    coolunits = cu;

    /*Initialize the cooling rates*/
    init_cooling_rates(TreeCoolFile, RecFastFile, MetalCoolFile, CP);
